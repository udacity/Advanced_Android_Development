 ...
 */
public class TodayWatchIntentService extends IntentService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    public TodayWatchIntentService() {
        super("TodayWatchIntentService");
    }
